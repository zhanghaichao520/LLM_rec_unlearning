...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, 
                        default='./Weights/LightGCN/Quick_LightGCN_ml100k.pth',
    ...
    parser.add_argument('--max_train_samples', type=int, default=20000, help='Maximum training samples')
...
class InfluenceFunctionRecommendationUnlearning(nn.Module):
    ...
    def compute_hessian_with_test(self, model=None, data_generator=None):
        ...
        def compute_batch_gradients(u_params, i_params, data_batch, batch_size=100):
        ...
        grad_u, grad_i = compute_batch_gradients(u_params, i_params, train_data, batch_size=100)
        ...
        forget_grad_u, forget_grad_i = compute_batch_gradients(u_params, i_params, forget_data, batch_size=100)
        ...
        def hvp_fn(v):
            ...
            batch_size = 1024  # Adapted for ML-100K dataset
...
def main():
    ...
    save_name = f"{save_dir}/ifru_lightgcn_100k_lr{args.if_lr}_damping{args.damping}.pth"
    ...
    results_path = f'{result_dir}/ifru_lightgcn_100k_lr{args.if_lr}_damping{args.damping}_results.json'
